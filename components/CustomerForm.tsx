    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        <div className="bg-primary px-4 py-3 flex justify-between items-center">
          <h2 className="text-white font-bold text-lg">새 고객 등록</h2>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700">매매/보증금</label>
              <input 
                type="text" 
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:border-primary focus:ring-primary"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">월세 (선택)</label>
              <input 
                type="text" 
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:border-primary focus:ring-primary"
