...
export const TabMeeting: React.FC<Props> = ({ customer, onUpdate }) => {
  ...
  const regeneratePropertyImage = async (propIndex: number) => {
    ...
    try {
      ...
      if (prop.parsedText) {
        html += `<div style="font-size: 13px; line-height: 1.6; white-space: pre-wrap; word-wrap: break-word; font-family: Arial, sans-serif; margin: 0 0 16px 0; color: #000; font-weight: 600;">${prop.parsedText}</div>`;
      }
